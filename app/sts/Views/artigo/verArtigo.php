...
if (!empty($this->Dados['dados_Artigo'][0])) {
    ...
    <div class="content p-1">
        <div class="list-group-item">
            ...
            <dl class="row">
                ...
                <dd class="col-sm-9"><?php echo $titulo; ?> - <i class="text-primary">autor: <?php echo $nome_user; ?></i></dd> 
            ...
            <dl class="row">
                ...
                <dd class="col-sm-9"><b class="text-primary"><?php echo $nome_user; ?></b></dd> 
    ...
    $_SESSION['msg'] = "<div class='alert alert-danger'>Erro: Artigo não foi encontrado!</div>";
