        ...
        <form method="POST" action="" enctype="multipart/form-data"> 
            ...
            <div class="form-row">
                <div class="form-group col-md-4">
                    <label>
                        <span tabindex="0" data-toggle="tooltip" data-placement="top" data-html="true" title="Página de icone: <a href='https://infinitered.github.io/ionicons-version-3-search/' target='_blank'>Ionicons</a>. Somente inserir o nome, Ex: ion-ios-camera-outline">
