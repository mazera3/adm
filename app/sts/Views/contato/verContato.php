    ...
    <div class="content p-1">
        <div class="list-group-item">
            ...
            <dl class="row">
                ...
                <dt class="col-sm-3">Responder E-mail</dt>
                <dd class="col-sm-9"><?php
                if ($this->Dados['botao']['resp_contato']) {
                    echo "<a href='" . URLADM . "responder/responder-contato/$id' class='btn btn-outline-info btn-sm'>Responder</a> ";
                }
                ?></dd>
