...
class StsResponder
{
    ...
    public function respContato(array $Dados)
    {
        $this->Dados = $Dados;
        $this->validarDados();
        if ($this->Resultado) {
    ...
    {
        $repContato = new \App\adms\Models\helper\AdmsCreate();
        $repContato->exeCreate('sts_contatos', $this->Dados);
